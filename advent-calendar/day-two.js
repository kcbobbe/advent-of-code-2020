...
var inputDayTwo = challengeInput.split('\n')

// var a = (inputDayTwo[999].split('-'))
// var firstNumber = a[0]
// var b = (a[1].split(' '))
...
// var letterRegExp = new RegExp(letter,"g");

// var count = (password.match(letterRegExp) || []).length;
// console.log('count', count)
// console.log('first number: ', firstNumber, 'second number:', secondNumber, 'letter: ', letter, 'password: ', password)

function dayTwo1() {
    var numberOfValidPasswords=0
    for (var i = 0; i < inputDayTwo.length; i++){
        var a = (inputDayTwo[i].split('-'))
        var firstNumber = a[0]
        var b = (a[1].split(' '))
        var secondNumber = b[0]
        var c = b[1].split(':');
...
function dayTwo2() {
    ...
    for (var i = 0; i < inputDayTwo.length; i++){
        var a = (inputDayTwo[i].split('-'))
        var firstNumber = a[0] - 1
        var b = (a[1].split(' '))
        var secondNumber = b[0] - 1
        var c = b[1].split(':');
        var letter = c[0]
        var password = b[2]

        if (password[firstNumber] === letter && password[secondNumber] === letter) {
            // console.log('both positions taken')
        } else if (password[firstNumber] === letter || password[secondNumber] === letter) {
            numberOfValidPasswords +=1
        }
    }
    return numberOfValidPasswords;
